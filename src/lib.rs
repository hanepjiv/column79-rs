...
impl Column79 {
    ...
    pub fn run(
        ...
        if !config_default_path.exists() {
            Column79::create_config(
                config_default_path.clone(),
                CONFIG_DEFAULT,
            )?
        }
        // config_user_path  --------------------------------------------------
        ...
        if !config_user_path.exists() {
            Column79::create_config(config_user_path.clone(), CONFIG_USER)?
        }
